...
IFontDisp = Font
__all__ = [ 'LoadPictureConstants', 'OLE_XPOS_CONTAINER', 'FONTBOLD',
           'Gray', 'FONTSTRIKETHROUGH', 'FONTITALIC',
           'OLE_XSIZE_HIMETRIC', 'OLE_XPOS_HIMETRIC', 'FONTSIZE',
           'VgaColor', 'IFont', 'OLE_YSIZE_PIXELS', 'IFontDisp',
           'Font', 'OLE_YPOS_HIMETRIC', 'Checked', 'StdPicture',
           'OLE_YPOS_PIXELS', 'OLE_YSIZE_HIMETRIC', 'OLE_CANCELBOOL',
           'OLE_XPOS_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
           'IFontEventsDisp', 'Unchecked', 'FONTNAME', 'OLE_HANDLE',
           'Default', 'OLE_YPOS_CONTAINER', 'OLE_TRISTATE', 'Color',
           'OLE_XSIZE_PIXELS', 'Picture', 'OLE_COLOR', 'FontEvents',
           'Monochrome', 'IPicture', 'OLE_OPTEXCLUSIVE',
           'OLE_XSIZE_CONTAINER', 'StdFont', 'IPictureDisp',
